...
class ThemePlugin(BaseAdminPlugin):
    ...
    theme934_theme = static('xadmin/css/themes/theme934.min.css')  # 添加自定义主题样式
    theme11_theme = static('xadmin/css/themes/theme11.min.css')  # 添加自定义主题样式
    ...
    def block_top_navmenu(self, context, nodes):
        ...
        themes = [
            ...
            # 下面这个是添加的自定义主题
            {'name': _(u"theme934"), 'description': _(u"theme934"), 'css': self.theme934_theme},
            {'name': _(u"theme11"), 'description': _(u"theme11"), 'css': self.theme11_theme},
            ]
